...
<div class="panel">
	<div class="content">
		<form action="" method="post">
			...
			<legend><?php _e( 'Add task', 'orbis_tasks' ); ?></legend>

			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label><?php _e( 'Description', 'orbis_tasks' ); ?></label>
				...
				<div class="col-md-6">
					<div class="form-group">
						<label><?php _e( 'Time', 'orbis_tasks' ); ?></label>
			...
			<div class="form-group">
				<label><?php _e( 'Project', 'orbis_tasks' ); ?></label>
			...
			<div class="form-group">
				<label><?php _e( 'Person', 'orbis_tasks' ); ?></label>
				<?php
			...
			<div class="form-group">
				<label><?php _e( 'Date', 'orbis_tasks' ); ?></label>
			...
			<div class="form-actions">
				<button type="submit" class="btn btn-primary" name="orbis_task_add"><?php _e( 'Save task', 'orbis_tasks' ); ?></button>
				<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#demo"><?php _e( 'Cancel', 'orbis_tasks' ); ?></button>
			</div>
		</form>
	</div>
</div>