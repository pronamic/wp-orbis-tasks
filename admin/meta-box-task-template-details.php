...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			<input id="orbis_task_template_creation_date" name="_orbis_task_template_creation_date" value="<?php echo esc_attr( $task_template->creation_date ); ?>" type="date" class="regular-text" />
		</td>
	</tr>
	<tr valign="top">
		<th scope="row">
		...
		<td>
			<input id="orbis_task_template_start_date" name="_orbis_task_template_start_date" value="<?php echo esc_attr( $task_template->start_date ); ?>" type="date" class="regular-text" />
		</td>
	</tr>
	<tr valign="top">
		<th scope="row">
		...
		<td>
			<input id="orbis_task_template_end_date" name="_orbis_task_template_end_date" value="<?php echo esc_attr( $task_template->end_date ); ?>" type="date" class="regular-text" />
		</td>
	</tr>
	<tr valign="top">
		<th scope="row">
		...
		<td>
			<input id="orbis_task_template_next_creation_date" name="_orbis_task_template_next_creation_date" value="<?php echo esc_attr( $task_template->next_creation_date ); ?>" type="date" class="regular-text" />
		</td>
	</tr>
</table>
